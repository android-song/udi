...
public  class DataBaseAdapter extends BaseAdapter {
    ...
    public DataBaseAdapter(List<UserItem> userItems, Context baseContext) {
...
//        userList.addOnListChangedCallback(mDataListener);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
          convertView= LayoutInflater.from(context).inflate(R.layout.list_text_item,parent,false);
